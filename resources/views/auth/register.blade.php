    ...
    <div class="bgCuenta">
        <div class="container register">
            <form method="POST" action="{{ route('register') }}">
                ...
                <p class="text-center">Regístrate en Green Travel para disfrutar de todas las experiencias que
                    ofrecemos.<br>Si
                ...
                <div class="row m-3">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input id="surname" name="surname" class="form-control" type="text"
                            @error('surname') is-invalid @enderror" value="{{ old('surname') }}" required
