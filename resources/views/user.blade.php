                        ...
                        <div class="container p-4">
                            <form method="post">
                                ...
                                <div>
                                    <div class="row m-3">
                                        <div class="col-md-6 col-sm-12">
                                            <label>País</label><select class="form-control" type="text" name="country" required><br>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <label>Localidad</label><input class="form-control" type="text" name="city" placeholder="*" required><br>
                                        </div>
                                        <div class="col-sm-12">
                                            <label>Correo electrónico</label><input class="form-control" type="text" name="street" placeholder="Dirección exacta" value="{{old('email')}}" required></div><br>
                                        </div>
                                    </div>
                                </div>
