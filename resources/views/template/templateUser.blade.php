            ...
            <div class="col-md-2 col-sm-2 p-0 bg-light">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-menu mt-0">
                        <a id="menu-user" href="{{ route('user') }}"><h4 class="text-dark p-4">Cuenta</h4></a><hr class="m-0">
                        <a id="menu-user" href="{{ route('favoritos') }}"><h4 class="text-dark p-4">Favoritos</h4></a><hr class="m-0">
                        <a id="menu-user" href="{{ route('cambiarPassword') }}"><h4 class="text-dark p-4">Cambio contraseña</h4></a><hr class="m-0">
                        <a id="menu-user" href="{{ route('direccion') }}"><h4 class="text-dark p-4">Dirección</h4></a><hr class="m-0">
